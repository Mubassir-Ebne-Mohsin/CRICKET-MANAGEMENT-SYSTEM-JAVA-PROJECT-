...
public class Bkash2 extends JFrame implements ActionListener
{
	JPanel p;
	JLabel l1,l2,l3,l;
	JTextField t1;
	...
	Bkash2()
	{
		...
		img = new ImageIcon(getClass().getResource("Untitled design (5) (1).JPG"));
